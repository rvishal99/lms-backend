...
//         maxLength: [59, 'Name should be less than 50 characters'],
//         lowercase: true,
//         trim: true
//     },
//     email: {
...
//         unique: true,
//         match: [
//             /^[A-Za-z0-9_!#$%&'*+\/=?`{|}~^.-]+@[A-Za-z0-9.-]+$/, "Please fill in a valid email address",
//         ]
...
//             id: this._id, email: this.email, subscription: this._subscription
//         },
...
//     },
// };  
// const User = model('User', userSchema); // collName,Schema
...
userSchema.methods = {
  ...
  generateJWTToken: async function () {
    return await jwt.sign(
      { id: this._id, isAdmin: this.isAdmin, subscription: this.subscription },
      process.env.JWT_SECRET,
      {
        expiresIn: process.env.JWT_EXPIRY,
      }
